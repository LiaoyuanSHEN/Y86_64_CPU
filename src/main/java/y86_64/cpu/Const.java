...
public class Const {
    ...
    public static int RBX = 1;
    public static int RCX = 2;
    public static int RDX = 3;
    public static int RSP = 4;
    public static int RBP = 5;
    public static int RSI = 6;
    public static int RDI = 7;
    public static int R08 = 8;
    public static int R09 = 9;
